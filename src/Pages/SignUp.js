                        ...
                        <form className="mt-3">
                            ...
                            <div className="row mb-3">
                                <div className="col-md-6">
                                    <TextField type="text" className="w-100" label="Name" variant="standard" required/>
                                </div>
                                <div className="col-md-6">
                                    <TextField type="number" className="w-100" id="standard-basic" label="Mobile" variant="standard" required/>
                                </div>
                            </div>
                            ...
                            <div className="d-flex align-items-center mt-3 mb-3">
                                <div className="row w-100">
                                    <div className="col-md-6 w-100">
                                        <Button className="btn-blue col btn-lg btn-big">SignUp</Button>
                                    </div>
                                    <div className="col-md-6 w-100 pr-0">
                                        <Link to="/"><Button className="col btn-lg btn-big" onClick={()=>context.setisHeaderFooterShow(true)} style={{ background: '#f6fafd'}}>Cancel</Button></Link>
                                    </div>
                                </div>
                            ...
                            <p className="txt">Already have an Account ? <Link to="/signin" className="border-effect">SignIn</Link></p>
                            ...
                            <Button className="loginwithGoogle mt-2"><img src={SignInGoogle} alt=""/>SignUp with Google</Button>
